...
| **相關規格** | [ZEP-0019](ZEP-0019-native-modules-portable-toolchain.zh-TW.md) |
...
安裝過程安全不代表原生程式碼已被沙箱隔離。建置 native 套件時，宣告的來源
與允許的 flags 會交給 C 工具鏈，產生的執行檔擁有使用者 process 的一般權限。
package root 限制、flag 政策、符號驗證、編譯器呼叫及明確 native-code 確認，
依照 [ZEP-0019](ZEP-0019-native-modules-portable-toolchain.zh-TW.md)。
